...
lang_pairs=en_XX-fr_XX,en_XX-de_DE,en_XX-zh_CN #a list language pairs to train multilingual models, e.g. "en-fr,en-cs,fr-en,cs-en"
...
ratios=$1
echo "["$ratios"]" 
TASK=base_model_3d_10Mfr4.6MDe260kzh_$ratios
